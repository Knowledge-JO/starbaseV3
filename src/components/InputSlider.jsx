...
const InputSlider = ({first="OFF", second="ON", state, dispatch, type}) => {
  
  return (
    <div>
      <label className="relative inline-block h-7 w-[70px] ">
        <input type="checkbox" className="peer w-0 h-0 opacity-0" value={state} checked={state} onChange={()=> dispatch({type})}/>
